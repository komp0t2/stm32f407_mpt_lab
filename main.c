...
int main()
{
    ...
    timer_init(TIM1, 0, 100, 16);  //Инициализация таймера предделитель 16, счетчик 100
    ...
    TIM1->CCER |= TIM_CCER_CC1E;  //Активация канала с регистра сравнения
